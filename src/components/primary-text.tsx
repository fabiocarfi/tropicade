...
const PrimaryText = ({ canvas }: { canvas: Canvas | null }) => {
  const [currentInput, setCurrentInput] = useState("");
  const [fontSize, setFontSize] = useState<number | string>(48);
    ...
    const existedText = canvas
      ...
      .filter(
        (obj): obj is CustomText =>
          "textType" in obj && obj.textType === "primary"
      );
